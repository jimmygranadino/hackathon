    ...
    return (
        <>
            ...
            <div class="row justify-content-center my-5" id="fade">
                    <h1 className="display-3 px-auto">Today, I am feeling...</h1>
            </div>
            <div class="row justify-content-lg-center text-center pb-5" id="fade">
                <div class="col-4"  onClick={submitNegative}>
                    <svg width="10vw" height="10vw" viewBox="0 0 16 16" class="bi bi-emoji-frown mbrace-emoji-s" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-4" onClick={submitNeutral}>
                    <svg width="10vw" height="10vw" viewBox="0 0 16 16" class="bi bi-emoji-neutral mbrace-emoji-n" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                ...
                <div class="col-4" onClick={submitPositive}>
                    <svg width="10vw" height="10vw" viewBox="0 0 16 16" class="bi bi-emoji-smile mbrace-emoji-h" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
