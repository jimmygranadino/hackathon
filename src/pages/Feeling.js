...
const Feeling = () => {
    ...
    let handleSubmit = (e) => {
        ...
        Axios.get(`${process.env.REACT_APP_SERVER_URL}/quotes`)
            .then(quote => {
    ...
    return (
        <>
            ...
            <div class="row justify-content-lg-center text-center pb-5" id="fade">
                <form class="col-4" onClick={handleSubmit}>
                    <input type="hidden" value="negative"></input>
                ...
                <form class="col-4" onClick={handleSubmit} onSubmit={handleSubmit}>
                    <input type="hidden" value="positive"></input>
