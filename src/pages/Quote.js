...
const Quote = () => {
    ...
    let handleClick = () => {
        Axios.get(`${process.env.REACT_APP_API}/quotes`)
            .then(quote => {
    ...
    let quotes = [
        {id: 0, quote: "If you change the way you look at things, the things you look at change.", author: "Anonymous", sentiment: "negative"},
